<script setup>
const phoneNumber = "573145978382";
...
<template>
  <section class="min-h-full flex flex-col" id="contacts">
    ...
    <div
      class="w-full h-16 md:h-10 flex justify-center items-center footer font-roboto text-center p-3 leading-5"
    >
      <p>© {{ new Date().getFullYear() }} WitCamDev - {{ $t("footer") }}</p>
    </div>
  </section>
</template>
